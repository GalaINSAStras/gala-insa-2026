  ...
  const tickets = [
    {
      ...
      type: "Étudiant",
      price: 25,
      description: "Accès à la soirée, cocktail dînatoire et une boisson incluse. Sur présentation d'un justificatif étudiant.",
    ...
    },
    {
      ...
      type: "Plein tarif",
      price: 45,
      description: "Accès à la soirée, cocktail dînatoire et une boisson incluse.",
    ...
    },
    {
      ...
      type: "VIP",
      price: 70,
      description: "Accès prioritaire, cocktail dînatoire, open bar et place réservée au premier rang pour le spectacle.",
